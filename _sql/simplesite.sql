...
CREATE TABLE IF NOT EXISTS `articles` (
  ...
  `categories` varchar(200) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
(1, 'My First Block', 'some content of block', '/starting-wtih-video', 'sidebar_below', 0, '', 'on', '2025-09-24 03:56:54'),

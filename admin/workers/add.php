...
if ('POST' === $_SERVER['REQUEST_METHOD']) {
	if (isUrlTaken($_POST['url'], 'workers')) {
	...
	$stmt = $conn->prepare('
	INSERT INTO 
	workers (name, email, phone, website, url, banner_image_url, social_url_media1, social_url_media2, social_url_media3, city, state, country, description, is_active, created_by, key_media_banner) 
	VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
	');

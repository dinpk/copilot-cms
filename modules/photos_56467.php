...
<div class="block">
	...
	$sql = "SELECT key_photo_gallery, title FROM photo_gallery ORDER BY RAND() LIMIT  " . getSetting('module_total_records');
	...
	echo "</ul>";
	echo "<p><a href='/photo-gallery'>" . getSetting('module_more_label') . "</a></p>";
	?>
</div>